...
import cv2
import pydicom
img = np.expand_dims(np.load(r"C:\Users\kesch\OneDrive\Desktop\Bratsimages_normalized_onlybrain\images\image_300.npy"), axis = 0)
msk = np.expand_dims(np.load(r"C:\Users\kesch\OneDrive\Desktop\Bratsimages_normalized_onlybrain\masks\mask_300.npy"), axis = 0)
