...
def create_dataset_from_patient_directory(patients_directory: str, output_dataset_directory: str) -> None:
...
def create_binary_masks_from_cropped_dataset(cropped_dataset: str, output_dataset_directory: str) -> None:
